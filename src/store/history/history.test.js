...
describe('History store', () => {
    ...
    it('Fetch history rates', () => {
        ...
        fetchMock.getOnce(
            ...
            {
                rates: {
                    '2020-03-05': { EUR: 1.1538017769 },
                    '2020-02-28': { EUR: 1.1721268241 },
                    '2020-03-04': { EUR: 1.1514104778 },
                    '2020-03-02': { EUR: 1.1479342922 },
                    '2020-03-06': { EUR: 1.1472494694 },
                    '2020-03-03': { EUR: 1.1492931847 },
                },
                start_at: '2020-02-28',
                base: 'GBP',
                end_at: '2020-03-06',
